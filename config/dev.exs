...
config :weather_aggregator, WeatherAggregatorWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "B1L1QLI9AktBhN1v6m/o+UE7i5Zn5pUTOm6Ys9NsTWJnen/qs2EXf+1+ierkqZcF",
  watchers: [
...
config :weather_aggregator, WeatherAggregatorWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/weather_aggregator_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :weather_aggregator, dev_routes: true
